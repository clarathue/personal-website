...
const Impressum = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-gray-50 pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-semibold text-tech-gray-800 mb-4">Umsatzsteuer-ID</h2>
          <p className="mb-6">
